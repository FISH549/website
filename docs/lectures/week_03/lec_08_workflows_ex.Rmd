...
**Task:** Skip the following instructions for creating a new branch from within GitHub. We'll use the second approach here.
</div>
...
<ul>
  ...
  <li>lines 3-10: Git pushed all of your local files to the `develop` branch on the remote GitHub repo.</li>
</ul>
