...
## jittered dotplot
p1 <- pp + geom_jitter(shape = 16, position = position_jitter(0.3), size = 2) + theme_bw()
## violin plot
p2 <- pp + geom_violin(size = 1.5) + theme_bw()
## combine plots
p1 + p2 &
