...
We use GitHub to [manage survey deployment and share code](https://github.com/afsc-gap-products), SQL to interact with our databases, R packages to store and share reproducible methods (e.g. [coldpool](https://github.com/afsc-gap-products/coldpool)), and Markdown to create reproducible reports ([Bering Sea](https://github.com/afsc-gap-products/gap_bs_data_report), [Gulf of Alaska/Aleutian Islands](https://github.com/MargaretSiple-NOAA/goa-ai-data-reports))
...
### 2) Clear pathways for implementing advice
