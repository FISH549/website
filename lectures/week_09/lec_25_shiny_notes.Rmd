...
- Shiny apps are *reactive* apps, which received packets of information from other places (in our case, the user-- but it could be other things like databases) and respond to those packets of information in real time.
