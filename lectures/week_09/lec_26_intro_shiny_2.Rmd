...
`leaflet` code builds plots in layers, similar to visualization tools like `ggplot2`.

You build an interactive map like this:

```{r}
library(leaflet)
leaflet() |> 
  addTiles() |>
  setView( -122.31637,47.65316, zoom = 17)
```
