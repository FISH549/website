...
`r fontawesome::fa('clipboard-list', height='20px')` Click on the **Sign up** button in the upper right.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Enter the email address you'd like to associate with your account.
</div>

<div class="alert alert-warning">
`r fontawesome::fa('lightbulb', height='20px')` **Tip:** You can change your email address or add another one later.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Enter a password.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Select a username for your account. This will form part of the URL where you will access your account (i.e., `https://github.com/USERNAME`).
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` You will then have to answer a question about electing to receive notices and info from GitHub. Feel free to choose no ("n").<br>

`r fontawesome::fa('clipboard-list', height='20px')` After you solve a quick puzzle to confirm you are, in fact, a human being, GitHub will send you an email with a 6-digit code to enter.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Log into your account on GitHub.
</div>

<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Click on the **+** sign in the upper right and select **New repository**.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Give your new repository a name. You can use underscores `_` and hypens `-` as text delimiters if you'd like. For now, call it **testing**.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` Enter some descriptive text in the **Description** field. This can be changed later, so you can keep it simple for now.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` GitHub repos can be set to **Public** or **Private**. If set to public, anyone can browse the contents of your repo. If set to private, only you and those you specify as collaborators can view the contents of the repo.
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` When you create a repo, you have the option of initializing it with a `README.md` file, a `.gitignore` file, and a license. For now, just check the box next to **Add a README file**.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` When you are finished, click on the green **Create repository** button.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard-list', height='20px')` You now have a new repo that is ready to be populated with folders, code, data sets, etc.
</div>
