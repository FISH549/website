...
**Warning:** You will need a GitHub account before you can start using it. If you do not have an account already, please see the info [here](https://FISH549.github.io/website/references/github_signup.html) for creating one.
</div>
...
<div class="boxy boxy-orange boxy-lightbulb">
**Tip:** You can preview a formatted version of your text by clicking the **Preview changes** tab.
</div>
