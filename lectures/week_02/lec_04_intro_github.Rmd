...
`r fontawesome::fa('clipboard', height='20px')` Click on the **Sign up** button in the upper right.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard', height='20px')` Enter the email address you'd like to associate with your account.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard', height='20px')` Enter a password.
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard', height='20px')` Select a username for your account. This will form part of the URL where you will access your account (i.e., `https://github.com/USERNAME`).
</div>
...
<div class="alert alert-info">
`r fontawesome::fa('clipboard', height='20px')` You will then have to answer a question about electing to receive notices and info from GitHub. Feel free to choose no ("n").<br>

`r fontawesome::fa('clipboard', height='20px')` After you solve a quick puzzle to confirm you are, in fact, a human being, GitHub will send you an email with a 6-digit code to enter.
</div>
