...
This is a step-by-step guide to create a new database, establish a user ID, and create/insert tables 
containing limnological data from Lake Washington (Seattle, WA, USA) and the Pacific Decadal Oscillation (PDO) 
climate index.
