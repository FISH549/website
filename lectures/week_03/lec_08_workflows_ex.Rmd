...
2. your remote origin (located at `https://github.com/USERNAME/ex-fork`)

3. your remote upstream (located at `https://github.com/FISH549/ex-fork`)
...
* the repo location (here it's the `upstream` at `https://github.com/FISH549/ex-fork`)
