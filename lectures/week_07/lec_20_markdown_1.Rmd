...
![](images/rmd_html_index_1.png)

![](images/rmd_html_index_2.png)
...
<div class="boxy boxy-blue boxy-clipboard-list">
**Task:** In the **Website** field, type or copy/paste the link to you rendered site, which should be `https://USERNAME.github.io/markdown-demo/` where `USERNAME` is your GitHub username. Click on the green **Save changes** button when you're done.
</div>
