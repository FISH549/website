...
For example, the following `date` option will print as `day full-month-name four-digit-year`. Check out the options for the R function `format()` to see how to change the date format.
