...
<div class="boxy boxy-orange boxy-lightbulb">
**Tip:** If you'd like to see an example of how one might use the `{readxl}` package in a workflow, check out Mark's project on estimating trends in the density of bull trout across the Pacific Northwest [here](https://github.com/mdscheuerell/bulltrout/blob/main/R/01_data-wrangling.R).
</div>
...
<ol>
  <li>specify the entire URL</li>
  <li>specify only the sheet ID</li>
</ol>
</div>
...
<div class="boxy boxy-blue boxy-clipboard-list">
**Task:** Begin by reading in the JSON file located at 
