...
<div class="boxy boxy-blue boxy-clipboard-list">
**Task:** Use `create_github_token()` to open up the new tokens on GitHub.
</div>
...
<div class="boxy boxy-blue boxy-clipboard-list">
&nbsp; **Task:** Scroll down to the **Select scopes** section and check these additional boxes:
<ul>
  <li>**notifications**</li>
  <li>**delete_repo**</li>
  <li>**project**</li>
...
If you use a password management app (e.g., **1Password**, **LastPass**) you might want to add your new PAT to the entry for GitHub, where presumably you've already stored your username and password when you created your account.
