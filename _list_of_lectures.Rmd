...
intro_1 <- list(
  title = "Introduction",
  topics = c("<b>Course overview</b>", "Required software"),
  pdf = c(""),
  rmd = c("lectures/week_01/lec_00_class_overview.Rmd",
          "lectures/week_01/lec_01_intro_to_data_science.Rmd"),
  html = c("lectures/week_01/lec_00_class_overview.html",
           "lectures/week_01/lec_01_intro_to_data_science.html"),
...
intro_2 <- list(
  ...
  pdf = c(""),
  rmd = c("lectures/week_01/lec_01_intro_to_data_science.Rmd"),
  html = c("lectures/week_01/lec_01_intro_to_data_science.html"),
  background = c("[Leek & Peng (2015)](references/Leek_Peng_2015_what_is_the_Q.pdf)", "[D’Agostino McGowan (2020)](https://docs.google.com/presentation/d/1pZe8Sp350iYzsKsweZzR374179gvRwpI3cAX_NObgj8/edit#slide=id.p)", "[Peng (2018)](https://simplystatistics.org/posts/2018-06-04-trustworthy-data-analysis/)"),
  zoom = ""
)
...
analysis_steps <- list(
  ...
  pdf = c(""),
  rmd = c("lectures/week_01/lec_02_analysis_steps.Rmd"),
  html = c("lectures/week_01/lec_02_analysis_steps.html"),
...
## day 8b ####
workflows_2 <- list(
  title = "Practicing workflows",
  topics = c("<b>Practicing workflows</b>", "Centralized", "Feature branch", "Forking"),
  pdf = c(""),
  rmd = c("lectures/week_03/lec_08_workflows_ex.Rmd"),
  html = c("lectures/week_03/lec_08_workflows_ex.html"),
  background = c("[Sec VI of HGG](https://happygitwithr.com/workflows-intro.html)",
                 "[Learn Git branching](https://learngitbranching.js.org/)"),
  zoom = ""
)
...
working_with_data <- list(
  ...
  topics = c("<i>Markus Min</i>", "<b>Working with data</b>", "Chain of custody", "Tidy data", "Manual entry"),
  pdf = c(""),
...
databases_2 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Creating a database</b>", "Adding data", "Cleaning data", "Joining tables"),
  pdf = c(""),
  rmd = c("lectures/week_05/lec_14_intro_databases.Rmd",
          "lectures/week_05/lec_15_intro_databases.Rmd"),
  html = c("lectures/week_05/lec_14_intro_databases.html",
           "lectures/week_05/lec_15_intro_databases.html"),
  background = "",
  zoom = ""
)
...
databases_3 <- list(
  ...
  topics = c("<i>Jennifer Scheuerell</i>", "<b>Working with a database</b>", "SQL from R", "Queries"),
  pdf = c(""),
  rmd = "lectures/week_05/lec_16_working_databases.Rmd",
  html = "lectures/week_05/lec_16_working_databases.html",
  background = "",
  zoom = ""
)
...
shiny_1 <- list(
  ...
  html = c("lectures/week_09/lec_25_intro_shiny_1.html",
           "lectures/week_09/lec_25_26_shiny_notes.html"),
...
shiny_2 <- list(
  ...
  html = c("lectures/week_09/lec_26_intro_shiny_2.html",
           "https://margaretsiple.shinyapps.io/interactiveShinyNotes/"),
...
## extra ####
ebook <- list(
  title = "Publishing e-books",
  topics = c("<b>Publishing e-books</b>", "Bookdown", "Analysis & inference"),
  pdf = c(""),
  rmd = "lectures/week_10/lec_31_bookdown.Rmd",
  html = "lectures/week_10/lec_31_bookdown.html",
  background = c("[{bookdown} pkg](https://bookdown.org/yihui/bookdown/)",
                 "[Applied Ecology Lab guide](https://scheuerell-lab.github.io/lab-book/index.html)"),
  zoom = ""
)
```
