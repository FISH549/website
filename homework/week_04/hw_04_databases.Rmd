...
Open a new issue called `Assignment 4` in your `fish497` repo that you created as part of [Assignment 1](../week_01/hw_01_github_remotes.html) and include the screen shot from Task 7. To do so, you can simply drag and drop the image into the issue editing window.
